...
// rename the sheet
$objSheet->setTitle("Matching Question Format");
...
$objSheet->getCell('B1')->setValue('Matching Type');
// write header
...
$objSheet->getCell('A6')->setValue('2 US Presidential Candidates');
$objSheet->getCell('B6')->setValue('Clinton & Trump');
$objSheet->getCell('F6')->setValue('5');

$objSheet->getCell('A7')->setValue('Female Capstone Member');
$objSheet->getCell('B7')->setValue('Justineeee');
$objSheet->getCell('F7')->setValue('10');
...
header('Content-Disposition: attachment;filename="MatchingType_Question_Format.xlsx"');
